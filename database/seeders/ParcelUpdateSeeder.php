...
class ParcelUpdateSeeder extends Seeder
{
    public function run()
    {
        ...
        $updatedData = [
            [
                'customer_subcategories_data' => json_encode([
                    [
                        "category_id" => 1,
                        "subcategories" => [
        ...
        foreach ($parcels as $parcel) {
            DB::table('parcels')->where('id', $parcel->id)->update([
                'customer_subcategories_data' => $updatedData[$index]['customer_subcategories_data'],
        ...
        echo "✅ ParcelUpdateSeeder executed successfully!\n";
    }
}
