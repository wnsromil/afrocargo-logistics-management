jQuery(document).ready(function($){
    ...
    timelines.each(function() {
        ...
        if ($(this).hasClass('two')) {
            eventsMinDistance = 115; // Set a different value for timelines with the 'two' class
        }

        initTimeline($(this), eventsMinDistance); // Pass eventsMinDistance to initTimeline
    });

    function initTimeline(timeline, eventsMinDistance) {
