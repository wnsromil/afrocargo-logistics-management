...
class RoleManagementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.user_role.index', compact('parcels', 'drivers', 'warehouses'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $parcelTpyes = Category::whereIn('name', ['box', 'bag', 'barrel'])->get();
        return view('admin.user_role.edit', compact('parcel', 'warehouses', 'customers', 'drivers', 'parcelTpyes'));
    }
