<div class="header header-one nav-head shadow d-flex col-md-12 logopin align-items-center ">
    ...
    <div class="d-flex justify-content-between w-100">
        ...
        <div class="d-flex align-items-center float-end me-3 me-sm-4">
            ...
            <a class="nav-link height-52 p-2 position-relative" href="{{ route('admin.notification.index') }}" style="margin-top: 10px;">
            ...
            <div class="nav-profile">
                <button class="nav-link btn height-52 profile dropdown-toggle btnColor1 p-2" type="button"
