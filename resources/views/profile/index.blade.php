<x-app-layout>
    ...
    <div class="text-end mt-n4">
        <a class="btn update btn-primary me-2" href="{{ route('profile.edit') }}"><i class="ti ti-edit"></i> Update
            Profile</a>
        <a href="{{ route('profile.password') }}" class="btn update btn-primary"><i
                class="ti ti-lock-square-rounded"></i> Change Password</a>
    </div>
    <section>
                            ...
                            <div class="profile-picture text-center mb-0">
                                <div class="upload-profile me-2">
                                    <div class="profile-img">
                                        ...
                                        @else
                                            <img id="blah" class="avatar"
                                                src="{{  asset('assets/img/profiles/avatar-icon.png') }}" alt="profile-img">
                                        @endif
                                    </div>
                                </div>
                            </div>
                ...
                <div class="customer-details">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="customer-details-cont">
                            ...
                            <p class="col3A fw_mid">+{{ $user->phone_code->phonecode ?? '' }} {{ $user->phone ?? '-' }}
                            </p>
                            <p class="col3A fw_mid"> @if (!empty($user->phone_2))
