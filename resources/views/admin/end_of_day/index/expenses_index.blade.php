<x-app-layout>
    ...
    <form id="expenseFilterForm" action="{{ route('admin.end_of_day.Expenses_index') }}" method="GET">
    ...
    <div class="fw-600 fs-6 d-flex flex-wrap gap-3 summary-text">
        ...
        <div>Total Expenses: <span class="summary-amount">${{ number_format($totalExpensesamount, 2) }}</span></div>
    ...
    <div id='ajexTable'>
        <div class="card-table">
            <div class="text-center" style="color: black;">
                <span class="fw-600 fs-5">Expenses</span>
            </div>
            <div class="card-body">
    ...
    @section("script")
        <script>
            ...
            function resetForm() {
                window.location.href = "{{ route('admin.end_of_day.Expenses_index') }}";
            }
        </script>
          <script>
