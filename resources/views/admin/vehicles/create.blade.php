                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="input-block mb-3">
                        ...
                        <div class="daterangepicker-wrap cal-icon cal-icon-info">
                            <input style="cursor: pointer;" type="text" name="license_expiry_date"
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="input-block">
                        <label class="table-content col737 fw-medium">Vehicle Registration Document<i
                                class="text-danger">*</i></label>
                        <div class="input-block mb-3 service-upload img-size2">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="input-block mb-3">
                        <label for="vehicle_registration_exp_date" class="foncolor">Vehicle Registration Expire Date<i
                                class="text-danger">*</i></label>
                        <div class="daterangepicker-wrap cal-icon cal-icon-info">
                            <input style="cursor: pointer;" type="text" name="vehicle_registration_exp_date"
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="input-block mb-3">
                        <label for="vehicle_insurance_exp_date" class="foncolor">Vehicle Insurance Expire Date<i
                                class="text-danger">*</i></label>
                        <div class="daterangepicker-wrap cal-icon cal-icon-info">
                            <input style="cursor: pointer;" type="text" name="vehicle_insurance_exp_date"
