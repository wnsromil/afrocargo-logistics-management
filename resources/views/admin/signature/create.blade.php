<x-app-layout>
    ...
    <form action="{{ route('admin.signature.index') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group-customer customer-additional-form">
            <div class="row">
                <div class="row">
                    <div class="col-md-6 me-sm-2">
                        <div class="input-block mb-3">
                            <label for="tracking_number" class="colours"> Signature Name<i class="text-danger">*</i></label>
                            <input type="text" name="tracking_number" class="form-control" placeholder="Enter Signature Name">

                        </div>
                    </div>
                    <div class="col-md-6 me-sm-2">
                        <div class="input-block">
                            <label class="table-content profileUpdateFont fw-medium required colours">Upload Signature</label>
                            <div class="input-block mb-3 service-upload img-size2 mb-0">
                                <span id="upload_inventory_image">
                                    ...
                                    <h6 class="drop-browse align-center">Upload Signature</h6>
                                </span>
                ...
                <div class="add-customer-btns text-end">
                    <button type="button" onclick="redirectTo('{{ route('admin.signature.index') }}')" class="btn btn-outline-primary custom-btn">Cancel</button>
