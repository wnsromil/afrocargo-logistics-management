<x-app-layout>
            ...
            <div class="row">
                    ...
                    <div class="col-md-12 ms-3">
                        ...
                        <div class="d-flex mt-1">
                            ...
                            <div class="checkboxlable bg-color  ms-3">
                                <label class="custom_check primary font13 fw_500">
                                    <input type="checkbox" class="child-checkbox d_none" name="payment">
                                    <span class="checkmark check-size"></span>
                            ...
                            <div class="checkboxlable bg-color  ms-3">
                                <label class="custom_check primary font13 fw_500">
                                    <input type="checkbox" class="child-checkbox d_none" name="expenses">
                                    <span class="checkmark check-size"></span>
                    ...
                    <div class="col-md-12 p-32">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="PrintReport">
                                        <span class="checkmark check-size"></span>
                                        Print Report
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 mt-4 p-32">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="PrintInvoice">
                                        <span class="checkmark check-size"></span>
                                        Print Invoice
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="print_description">
                                        <span class="checkmark check-size"></span>
                                        Print Description
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 p-32">
                        <div class="twoRowsSec w-max-content mt-3 p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="newLang">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="deleteLang">
                                        <span class="checkmark check-size"></span>
                                        Deleting Language
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="editLang">
                                        <span class="checkmark check-size"></span>
                                        Editing Language
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 mt-4 p-32">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="managingTree">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="managing_roles">
                                        <span class="checkmark check-size"></span>
                                        Managing Roles
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 mt-4 p-32">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="Deletingrole">
                                        <span class="checkmark check-size"></span>
                                        Deleting role
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="Editingrole">
                                        <span class="checkmark check-size"></span>
                                        Editing role
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 mt-4 p-32">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="Creatingnewuser">
                                        <span class="checkmark check-size"></span>
                                        Creating new user
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="Deletinguser">
                                        <span class="checkmark check-size"></span>
                                        Deleting user
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="Editinguser">
                                        <span class="checkmark check-size"></span>
                                        Editing user
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="login_users">
                                        <span class="checkmark check-size"></span>
                                        Login For Users
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="blank_grid">
                                        <span class="checkmark check-size"></span>
                                        Set Blank Grid
                                    </label>
                                </div>
                ...
                <div class="col-md-12 ms-3 mt-4 ps-0">
                    ...
                    <div class="d-flex mt-1">
                        ...
                        <div class="checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_agent">
                                <span class="checkmark check-size"></span>
                                Delete Agent
                            </label>
                        </div>
                        <div class="checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_agent">
                                <span class="checkmark check-size"></span>
                                Edit Agent
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-2 ps-0">
                    ...
                    <div class="d-flex mt-1">
                        ...
                        <div class="checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_autocall">
                                <span class="checkmark check-size"></span>
                                Delete Autocall
                            </label>
                        </div>
                        <div class="checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_autocall">
                                <span class="checkmark check-size"></span>
                                Edit Autocall
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-2 ps-0">
                    ...
                    <div class="d-flex mt-1">
                        ...
                        <div class="checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_landing_detail">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_landing_detail">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-2 ps-0">
                    ...
                    <div class="d-flex mt-1">
                        ...
                        <div class="checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_landing_entity">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_landing_entity">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-2 ps-0">
                    ...
                    <div class="d-flex mt-1">
                        ...
                        <div class="checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_branch">
                                <span class="checkmark check-size"></span>
                                Delete Branch
                            </label>
                        </div>
                        <div class="checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_branch">
                                <span class="checkmark check-size"></span>
                                Edit Branch
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-2 ps-0">
                    ...
                    <div class="d-flex mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="DeleteClaim">
                                <span class="checkmark check-size"></span>
                                Delete Claim
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="EditClaim">
                                <span class="checkmark check-size"></span>
                                Edit Claim
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-2 ps-0">
                    ...
                    <div class="d-flex mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_container">
                                <span class="checkmark check-size"></span>
                                Delete Container
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="total_container">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_container">
                                <span class="checkmark check-size"></span>
                                Edit Container
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="blank_grid_2">
                                <span class="checkmark check-size"></span>
                                Set Blank Grid
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-2 ps-0">
                    ...
                    <div class="d-flex mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_container_expense">
                                <span class="checkmark check-size"></span>
                                Delete Claim
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_container_expense">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-2 ps-0">
                    ...
                    <div class="d-flex mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_tracking_report">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_tracking_report">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-2 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="customer_toLicense">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_customer">
                                <span class="checkmark check-size"></span>
                                Delete Customer
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="duplicate_customer">
                                <span class="checkmark check-size"></span>
                                Duplicate Customer
                            </label>
                        </div>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="license_active">
                                <span class="checkmark check-size"></span>
                                License Active
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="license_pic">
                                <span class="checkmark check-size"></span>
                                Upload License Pic
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-2 ps-0">
                    ...
                    <div class="d-flex mt-1">
                        ...
                        <div class="checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_customer_pickup">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="checkboxlable bg-color  ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_customer_pickup">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-2 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_relationship_manager">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_relationship_manager">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-2 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none"
                                    name="delete_relationship_manager_transaction">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none"
                                    name="edit_relationship_manager_transaction">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_delivery">
                                <span class="checkmark check-size"></span>
                                Delete Delivery
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_delivery">
                                <span class="checkmark check-size"></span>
                                Edit Delivery
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delivery_report">
                                <span class="checkmark check-size"></span>
                                Delivery Report
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delivery_report_print">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="is_payment">
                                <span class="checkmark check-size"></span>
                                Is Payment?
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-2 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_ios_modiules">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_ios_modiules">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_destriute_company">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_destriute_company">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_driver">
                                <span class="checkmark check-size"></span>
                                Delete Driver
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_driver">
                                <span class="checkmark check-size"></span>
                                Edit Driver
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_estimate">
                                <span class="checkmark check-size"></span>
                                Delete Estimate
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_estimate">
                                <span class="checkmark check-size"></span>
                                Edit Estimate
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_expense">
                                <span class="checkmark check-size"></span>
                                Delete Expense
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_expense">
                                <span class="checkmark check-size"></span>
                                Edit Expense
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_expense_category">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_expense_category">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_Inventory">
                                <span class="checkmark check-size"></span>
                                Delete Inventory
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_Inventory">
                                <span class="checkmark check-size"></span>
                                Edit Inventory
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="multiple_payments">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="make_payment">
                                <span class="checkmark check-size"></span>
                                Can Make Payment
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="print_custom_report">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="print_invoice">
                                <span class="checkmark check-size"></span>
                                Can Print Invoice
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="add_invoice">
                                <span class="checkmark check-size"></span>
                                Create New Invoice
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_invoice">
                                <span class="checkmark check-size"></span>
                                Delete Invoice
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_invoice">
                                <span class="checkmark check-size"></span>
                                Edit Invoice
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_invoice_container">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_invoice_date">
                                <span class="checkmark check-size"></span>
                                Edit Invoice Date
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="activate_buttons">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_ios_settings">
                                <span class="checkmark check-size"></span>
                                Delete Ios Settings
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_ios_settings">
                                <span class="checkmark check-size"></span>
                                Edit Ios Settings
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_manual_distribution">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_manual_distribution">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_misc_packages">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_misc_packages">
                                <span class="checkmark check-size"></span>
                                Edit Misc Packages
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_pd_ios">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_pd_ios">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_status">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_status">
                                <span class="checkmark check-size"></span>
                                Edit Package Status
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_package_type">
                                <span class="checkmark check-size"></span>
                                Delete Package Type
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_package_type">
                                <span class="checkmark check-size"></span>
                                Edit Package Type
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_pay_commission">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="pay_commission">
                                <span class="checkmark check-size"></span>
                                Pay Commission
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="pay_commission_batch">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="invooice_in_batch">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="manual_invoice_batch">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="commission_report">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="verify_batch_paskages">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_batch_packages">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="verify_status_list">
                                <span class="checkmark check-size"></span>
                                Verify Status List
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_payment_types">
                                <span class="checkmark check-size"></span>
                                Delete Pament Type
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_payment_types">
                                <span class="checkmark check-size"></span>
                                Edit Pament Type
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_petty-cash">
                                <span class="checkmark check-size"></span>
                                Delete Petty Cash
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_petty_transaction">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_petty-cash">
                                <span class="checkmark check-size"></span>
                                Edit Petty Cash
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="is_petty-cash">
                                <span class="checkmark check-size"></span>
                                Is Petty Cash
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="petty-cash-2">
                                <span class="checkmark check-size"></span>
                                Petty Cash
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_pickup">
                                <span class="checkmark check-size"></span>
                                Delete Pickup
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_pickup">
                                <span class="checkmark check-size"></span>
                                Edit Pickup
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="hide_verify">
                                <span class="checkmark check-size"></span>
                                Hide Verify Button
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="hide_shipto">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="pickup_management">
                                <span class="checkmark check-size"></span>
                                Pickup Management
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="add_deposit">
                                <span class="checkmark check-size"></span>
                                Create New Deposit
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_deposit">
                                <span class="checkmark check-size"></span>
                                Delete Deposit
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_deposit">
                                <span class="checkmark check-size"></span>
                                Edit Deposit
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="payment_auth">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="add_receipt">
                                <span class="checkmark check-size"></span>
                                Create New Receipt
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_receipt">
                                <span class="checkmark check-size"></span>
                                Delete Receipt
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_payment_date">
                                <span class="checkmark check-size"></span>
                                Edit Payment date
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_receipt">
                                <span class="checkmark check-size"></span>
                                Edit Receipt
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_report">
                                <span class="checkmark check-size"></span>
                                Delete Report
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_report">
                                <span class="checkmark check-size"></span>
                                Edit Report
                            </label>
                        </div>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="eod_report">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="isbranch">
                                <span class="checkmark check-size"></span>
                                Is Branch only
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="custom_invoice_total">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="custom_tracking_total">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="eod_report_2">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="no_totals">
                                <span class="checkmark check-size"></span>
                                No Totals
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="invoice_note">
                                <span class="checkmark check-size"></span>
                                Print Invoice Note
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="update_exrate">
                                <span class="checkmark check-size"></span>
                                Update ExRate
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="add_shipto">
                                <span class="checkmark check-size"></span>
                                Create New ShipTo
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_shipto">
                                <span class="checkmark check-size"></span>
                                Delete ShipTo
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_shipto">
                                <span class="checkmark check-size"></span>
                                Edit ShipTo
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_support">
                                <span class="checkmark check-size"></span>
                                Delete Support
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_support">
                                <span class="checkmark check-size"></span>
                                Edit Support
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_template">
                                <span class="checkmark check-size"></span>
                                Delete Template
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_template">
                                <span class="checkmark check-size"></span>
                                Edit Template
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_template_category">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_template_category">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_time_clock">
                                <span class="checkmark check-size"></span>
                                Delete Time Clock
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_time_clock">
                                <span class="checkmark check-size"></span>
                                Edit Time Clock
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_truck_maintenance">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_truck_maintenance">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_truck_module">
                                <span class="checkmark check-size"></span>
                                Delete Truck Entity
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_truck_module">
                                <span class="checkmark check-size"></span>
                                Edit Truck Module
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_truck_module_transac">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_truck_module_transac">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_vendor_entity">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_vendor_entity">
                                <span class="checkmark check-size"></span>
                                Edit Vendor Entity
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_vendor_invoice">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_vendor_invoice">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_vendor_payment">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_vendor_payment">
                                <span class="checkmark check-size"></span>
                                Edit Vendor Payment
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_bulk_delivery">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_warehouse">
                                <span class="checkmark check-size"></span>
                                Delete Warehouse
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_warehouse">
                                <span class="checkmark check-size"></span>
                                Edit Warehouse
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="update_warehouse_container">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_zone">
                                <span class="checkmark check-size"></span>
                                Delete Zone
                            </label>
                        </div>
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_zone">
                                <span class="checkmark check-size"></span>
                                Edit Zone
                            </label>
                        </div>
                ...
                <div class="col-md-12 ms-3 mt-1 ps-0">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="delete_zone_definition">
                                <span class="checkmark check-size"></span>
                        ...
                        <div class="col-auto checkboxlable bg-color ms-3">
                            <label class="custom_check primary font13 fw_500">
                                <input type="checkbox" class="child-checkbox d_none" name="edit_zone_definition">
                                <span class="checkmark check-size"></span>
                ...
                <div class="col-md-12 mt-4 ps-3">
                    ...
                    <div class="col-md-12 p-32">
                        <div class="twoRowsSec w-max-content mt-3 p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="cancelAutoRenewal">
                                        <span class="checkmark check-size"></span>
                                        Cancel Auto Renewal
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 mt-4 p-32">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="editCard">
                                        <span class="checkmark check-size"></span>
                                        Edit Card
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="deleteCard">
                                        <span class="checkmark check-size"></span>
                                        Delet Card
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_state_tc">
                                        <span class="checkmark check-size"></span>
                                        Edit State TC
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_city_tc">
                                        <span class="checkmark check-size"></span>
                                        Edit City TC
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_province_tc">
                                        <span class="checkmark check-size"></span>
                                        Edit Province TC
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_municipal_tc">
                                        <span class="checkmark check-size"></span>
                                        Edit Municipal TC
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_sector_tc">
                                        <span class="checkmark check-size"></span>
                                        Edit Sector TC
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="customer_srepo">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="shipTo_srepo">
                                        <span class="checkmark check-size"></span>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_package_master">
                                        <span class="checkmark check-size"></span>
                                        Edit Package Master
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_warehouse_pt">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="delete_warehouse_pt">
                                        <span class="checkmark check-size"></span>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="verify_pdist">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_pdist">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="delete_pdist">
                                        <span class="checkmark check-size"></span>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="missing_packs">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="batch2">
                                        <span class="checkmark check-size"></span>
                                        Batch
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="addto_batch2">
                                        <span class="checkmark check-size"></span>
                                        Add To Batch
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="create_batch2">
                                        <span class="checkmark check-size"></span>
                                        Create Batch
                                    </label>
                                </div>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_batch">
                                        <span class="checkmark check-size"></span>
                                        Edit Batch
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="delete_batch">
                                        <span class="checkmark check-size"></span>
                                        Delete Batch
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="change_driver_batch">
                                        <span class="checkmark check-size"></span>
                                        Change Driver Batch
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="delete_batch_packs">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="print_report2">
                                        <span class="checkmark check-size"></span>
                                        Print Report
                                    </label>
                                </div>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="print_province">
                                        <span class="checkmark check-size"></span>
                                        Print Province
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="batch3">
                                        <span class="checkmark check-size"></span>
                                        Batch
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="batch_packs3">
                                        <span class="checkmark check-size"></span>
                                        Batch Packages
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_ex-rate">
                                        <span class="checkmark check-size"></span>
                                        Edit Exchange Rate
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="delete_ex-rate">
                                        <span class="checkmark check-size"></span>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_wrh_lm">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="delete_wrh_lm">
                                        <span class="checkmark check-size"></span>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_pickup_add">
                                        <span class="checkmark check-size"></span>
                                        Edit PickUp Address
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="delete_pickup_add">
                                        <span class="checkmark check-size"></span>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_tenant_user">
                                        <span class="checkmark check-size"></span>
                                        Edit Tenant Users
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="delete_tenant_user">
                                        <span class="checkmark check-size"></span>
                                        Delete Tenant Users
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="duplicate_user">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="unlocked_user">
                                        <span class="checkmark check-size"></span>
                                        Lock Unlock User
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="user_login">
                                        <span class="checkmark check-size"></span>
                                        Login User
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="update_role">
                                        <span class="checkmark check-size"></span>
                                        Update Role Users
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="update_shift">
                                        <span class="checkmark check-size"></span>
                                        Update Timer Shift
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="checkboxlable bg-color  ms-3">
                                <label class="custom_check primary font13 fw_500">
                                    <input type="checkbox" class="child-checkbox d_none" name="edit_company_settings">
                                    <span class="checkmark check-size"></span>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_role_2">
                                        <span class="checkmark check-size"></span>
                                        Edit Role
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="delete_role_2">
                                        <span class="checkmark check-size"></span>
                                        Delete Role
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="delete_dri_invent">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="send_pdf">
                                        <span class="checkmark check-size"></span>
                    ...
                    <div class="col-md-12 p-32 mt-4">
                        <div class="twoRowsSec w-max-content p-32">
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_custRepo">
                                        <span class="checkmark check-size"></span>
                                        Edit Custom Report
                                    </label>
                                </div>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="delete_custRepo">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="custRepo_print">
                                        <span class="checkmark check-size"></span>
                                        Print Custom Report
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="exp_custRepo">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="add_exp_custRepo">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_exp_custRepo">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="delete_exp_custRepo">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="edit_cust_repo">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="delete_cust_repo">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="item_repo_print">
                                        <span class="checkmark check-size"></span>
                                        Print Item Report
                                    </label>
                                </div>
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="status_report_print">
                                        <span class="checkmark check-size"></span>
                                ...
                                <div class="checkboxlable bg-color  ms-3">
                                    <label class="custom_check primary font13 fw_500">
                                        <input type="checkbox" class="child-checkbox d_none" name="verify_licen">
                                        <span class="checkmark check-size"></span>
                                        Verify License
                                    </label>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const grandCheckboxes = document.querySelectorAll('.grand-checkbox, .grand-ckeckbox');

            grandCheckboxes.forEach(grandCheckbox => {
                const grandContainer = grandCheckbox.closest('.col-md-12');

                if (!grandContainer) return;

                const parentCheckboxes = grandContainer.querySelectorAll('.parent-checkbox');
                const childCheckboxes = grandContainer.querySelectorAll('.child-checkbox');

                function updateBackgrounds() {
                    grandContainer.querySelectorAll('label.custom_check').forEach(label => {
                        const input = label.querySelector('input');
                        const box = label.closest('.checkboxlable');
                    ...
                    const grandLabel = grandCheckbox.closest('label.custom_check');
                    if (grandCheckbox.checked) {
                        grandLabel?.classList.add('active');
                    } else {
                        grandLabel?.classList.remove('active');
                    }
                }

                function updateGrandState() {
                    const anyParentChecked = [...parentCheckboxes].some(p => p.checked);
                    const anyChildChecked = [...childCheckboxes].some(c => c.checked);
                    grandCheckbox.checked = anyParentChecked || anyChildChecked;
                }

                grandCheckbox.addEventListener('change', () => {
                    const isChecked = grandCheckbox.checked;
                    parentCheckboxes.forEach(p => p.checked = isChecked);
                    childCheckboxes.forEach(c => c.checked = isChecked);
                    updateBackgrounds();
                });

                parentCheckboxes.forEach(parent => {
                    parent.addEventListener('change', () => {
                        const block = parent.closest('.col-md-12');
                        const children = block ? block.querySelectorAll('.child-checkbox') : [];
                ...
                childCheckboxes.forEach(child => {
                    child.addEventListener('change', () => {
                        const block = child.closest('.col-md-12');
                        const relatedChildren = block ? block.querySelectorAll('.child-checkbox') : [];
                        const anyChecked = [...relatedChildren].some(cb => cb.checked);

                        const parent = block.querySelector('.parent-checkbox');
