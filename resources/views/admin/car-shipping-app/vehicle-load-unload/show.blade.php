                            ...
                            <table class="table table-stripped table-hover datatable pxless notposition">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Self Drop</td>
                                        <td>MV Liberty</td>
                                        <td><span class="badge badge-soft-danger fs_13 py-2">Awaiting Drop</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>Pickup</td>
                                        <td>MV Liberty</td>
                                        <td><span class="badge badge-soft-success fs_13 py-2">Picked Up</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="card rounded-3 border-primary mb-0 secondway">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="input-block mb-3">
                                    <label>Notes</label>
                                    <p>condimentum nulla ac, pharetra urna. Etiam ex odio, rhoncus ut commodo sed, mattis actortor. condimentum nulla ac, pharetra urna. Etiam ex odio.</p>
                                </div>
                            </div>
                        </div>
                    </div>
