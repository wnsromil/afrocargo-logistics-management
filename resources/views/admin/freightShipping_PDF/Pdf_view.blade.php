<x-app-layout>
    ...
    <table
        ...
        <tbody style="border-bottom: 1px solid black !important margin-bottom-4px">
            ...
            <tr>
                <td></td>
                <td colspan="14" style="border: 1px solid #000; padding: 4px; text-align: left;">Product 1
                    Description</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td colspan="15" style="border: 1px solid #000; padding: 4px; text-align: left;">Product 2 Description
                </td>
            </tr>
    ...
    <p
        ...
        <p style=" font-weight:800">Generated By : CBM Calculator https://www.cbmcalculator.com/</p>
    </div> -->

        <!-- <div style="height:100%; width:100%; color:black; font-family: 'Times New Roman', Times, serif; margin: 0;">
        <div style="border: 2px solid black; border-left:0; border-right:0;">
            <div style="width:90%;">
                <h6 style="font-size: 18px; font-weight: 700; text-align:center; margin: 4px 0px;">Calculation Report
                </h6>

                <div style="display: flex; flex-wrap: wrap; justify-content: space-between; margin-bottom: 10px;">
                    <div style="width: 40%;">
                        <div style="display: flex; justify-content: space-between;">
                            <div style="width:60%">Customer :</div>
                            <span style="width: 35%">tss</span>
                        </div>
                        <div style="display: flex; justify-content: space-between;">
                            <div style="width: 60%">Container :</div> <span style="width:35%">Standard 20 Feet</span>
                        </div>
                        <div style="display: flex; justify-content: space-between;">
                            <div style="width:60%">Container Dimension :</div>
                            <span style="width:35%">590 x 235 x 239 cm</span>
                        </div>
                        <div style="display: flex; justify-content: space-between;">
                            <div style="width:60%">Container Volume/Used Volume :</div>
                            <span style="width:35%">10.31695 / 33.2000</span>
                        </div>
                        <div style="display: flex; justify-content: space-between;">
                            <div style="width:60%">Container Weight/Used Weight :</div>
                            <span style="width:35%">8373.6 / 21770.00</span>
                        </div>
                    </div>

                    <div style="width: 48%;">
                        <div style="display: flex; justify-content: space-between;">
                            <div style="width:50%">Calculation # :</div><span style="width:40%"> tss/1</span>
                        </div>
                        <div style="display: flex; justify-content: space-between;">
                            <div style="width:50%">Calculation date :</div>
                            <span style="width:40%"> 30/Jan/2021</span>
                        </div>
                        <div style="display: flex; justify-content: space-between;">
                            <div style="width:50%">From :</div><span style="width:40%"> India - Cochin</span>
                        </div>
                        <div style="display: flex; justify-content: space-between;">
                            <div style="width:50%">To :</div><span style="width:40%"> United States -
                                Houston, Texas</span>
                        </div>
                        <div style="display: flex; justify-content: space-between;">
                            <div style="width:50%">Container Freight :</div>
                            <span style="width:40%"> 1200.0000 USD</span>
                        </div>
                    </div>
                </div>
            </div>
