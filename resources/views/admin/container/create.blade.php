        ...
        <div class="form-group-customer customer-additional-form">
            <div class="row">
                ...
                @if($role_id == 1)
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 container-inputs container-size-field">
                        <div class="input-block mb-3">
                            ...
                            <select name="container_size" id="container_size" class="js-example-basic-single select2">
                                <option value="">Select Size</option>
                                @foreach ($containerSizes as $size)
                                    <option value="{{ $size->id }}" data-volume="{{ $size->volume }}"
                            ...
                            <div class="mb-3">
                                ...
                                <select id="company_for_container" name="company_for_container" class="profileUpdateFont">
                                    ...
                                    @foreach ($viewVContainercompanys as $viewVContainercompany)
                                        <option
                                            {{ old('company_for_container') == $viewVContainercompany->name ? 'selected' : '' }}
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 seal-no-field">
                        <div class="input-block mb-3">
                            ...
                            <input type="text" name="port_of_discharge" id="port_of_discharge"
                                class="form-control inp" placeholder="Enter port of discharge"
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 seal-no-field">
                        <div class="input-block mb-3">
                            <label for="celliling_date" class="foncolor">Celliling Date<i
                                    class="text-danger">*</i></label>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 seal-no-field">
                        <div class="input-block mb-3">
                            ...
                            <input type="text" name="eta_date" readonly style="cursor: pointer;"
                                class="form-control inp" value="{{ old('eta_date') }}" placeholder="M/DD/YYYY" />
                            @error('eta_date')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 seal-no-field">
                        <div class="input-block mb-3">
                            <label for="chassis_number" class="foncolor">Chassis Number<i
                                    class="text-danger">*</i></label>
                    ...
                    <!-- Ship To Country -->
                    <div class="col-lg-4 col-md-6 col-sm-12 seal-no-field">
                        <label class="foncolor" for="ship_to_country">Ship To Country <i
                                class="text-danger">*</i></label>
                            ...
                            <select id="ship_to_country" name="ship_to_country" class="js-example-basic-single select2">
                                ...
                                @foreach (setting()->warehouseContries() as $country)
                                    <option value="{{ $country['name'] }}"
                                        {{ old('ship_to_country') == $country['name'] ? 'selected' : '' }}>
                                        {{ $country['name'] }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    if (warehouseId) {
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $('#gateInDriver').empty().append(
                                    '<option value="">Select Driver</option>');
                                $('#gateOutDriver').empty().append(
                                    '<option value="">Select Driver</option>');

                                // Add new driver options
                                $.each(data.data, function(key, driver) {
                                    var option = '<option value="' + driver.id + '">' +
                                        driver.name + '</option>';
