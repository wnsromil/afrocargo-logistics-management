        ...
        <div style="border:solid 1px #737B8B; height:590px;width:650px;margin-top:87px;border-radius:6px;">
            <div class="d-flex">
                ...
                <div class="challanh">
                    ...
                    <p class="invoicei">Tel 718-954-9093</p>
                </div>
            ...
            <div>
                ...
                <div class="delta">
                    <div><span>Date: </span><span style="font-weight:600">02-25-2023</span></div> <span style="font-weight:600">Ivoirien Cargo</span>
                </div>
                <div class="shift">
                    <div>
                        <span class=" invoicem">Ship To:</span>
                        <span>
                            <p class="invoiceaa">Walter Roberson</p>
