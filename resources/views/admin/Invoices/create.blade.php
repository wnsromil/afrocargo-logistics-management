...
<div class="row d-flex" style="justify-content: space-between;">
    ...
    <div class="input-container" style="display:flex; position: relative;border: 1px solid #00000042;border-radius: 5px !important;">
    ...
    text-align: center;">Auto</div>
        ...
        <input type="text" class="form-control form-cs inp" placeholder="INV 00021" style=" border:none !important">
    </div>
    </div>
   ...
   <select class="js-example-basic-single select2 ">
    ...
    <div class="input-container" style="position: relative;">
        <img src="../assets/img/invoices/$.png" alt="img" style="position: absolute; left: 10px; top: 50%; transform: translateY(-50%); width: 11px; height: 24px;">
        <input type="text" class="form-control form-cs inp" placeholder="0.00" style="padding-left: 30px;">
    </div>
</div>
<div class="col-md-3">
    <label>Due Date <i class="text-danger">*</i></label>
    <div class="daterangepicker-wrap cal-icon cal-icon-info" >
     <input type="text" class="btn-filters  form-cs inp " name="datetimes" placeholder="From Date - To Date"  />
    </div>
</div>
										...
										<table class="table table-bordered ">
											...
											<tbody>
												<tr>
													...
													<td> <input type="text" class="form-control tdbor inputcolor" placeholder="" ></td>
                                                    <td> <input type="text" class="form-control tdbor inputcolor" placeholder="" ></td>
                                                    <td> <div class="d-flex"><input type="text" class="form-control inputcolor" placeholder="" ><img  class="plusimg"src="../assets/img/Vector (8).png" alt="Icon"></div></td>
                                                    <td> <input type="text" class="form-control tdbor inputcolor" placeholder="" ></td>
                                                    <td><input type="text" class="form-control tdbor inputcolor" placeholder="" ></td>
                                                    <td><input type="text" class="form-control tdbor inputcolor" placeholder="" ></td>
                                                    <td><input type="text" class="form-control tdbor inputcolor" placeholder="" ></td>
  ...
  <div class="image-container imgin">
   ...
   <img src="../assets/img/edit.png" alt="img">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control tdbor inputcolor " placeholder="" ></td>
                                                    <td><input type="text" class="form-control tdbor inputcolor" placeholder="" ></td>
                                                    <td style="padding-left:0px !important"><div class="image-container imgin" style="margin-left:0px !important"><img src="../assets/img/dlt.png" alt="img"><img src="../assets/img/add.png" alt="img"><img src="../assets/img/edit.png" alt="img"></div></td>
                        ...
                        <div class="d-flex" style="background-color:#203A5F;height:105px;margin-top:20px">
                            ...
                            <input type="text" class="form-control form-cs" placeholder="0" ></div>
                            <div><label>Tax</label> 
                            <input type="text" class="form-control form-cs" placeholder="0" ></div>
