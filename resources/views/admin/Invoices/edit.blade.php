<x-app-layout>
    ...
    <x-slot name="cardTitle">
        ...
        <div class="d-flex align-items-center">
            ...
            <a class="circleIconBtn" data-bs-placement="bottom" title="Individual Payment"><i class="ti ti-cash"></i></a>
            <a class="circleIconBtn" data-bs-placement="bottom" title="Claim"><i class="ti ti-report-money"></i></a>
            <a class="circleIconBtn" data-bs-placement="bottom" title="Print"><i class="ti ti-printer"></i></a>
            <a class="circleIconBtn" data-bs-placement="bottom" title="Labels"><i class="ti ti-tag-starred"></i></a>
            <a class="circleIconBtn" data-bs-placement="bottom" title="Tracking"><i class="ti ti-route"></i></a>
            <a class="circleIconBtn" data-bs-placement="bottom" title="Notes"><i class="ti ti-notebook"></i></a>
        </div>
    </x-slot>
    ...
    <div class="modal custom-modal fade" id="invoiceHistory" role="dialog">
