<x-app-layout>
                ...
                <div class="row borderset">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="website_url" class="form-control inp"
                            value="{{ old('website_url', $user->website_url) }}" placeholder="Enter Website ID">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" id="License_ID" name="license_number" class="form-control inp"
                            value="{{ old('license_number', $user->license_number) }}" placeholder="Enter License ID">
                    </div>
    ...
    'selected' : '' }}>Hindi</option>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea id="Read_Comment" name="read_comment" class="form-control inp commenth" rows="3"
