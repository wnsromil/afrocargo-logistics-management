    ...
    <div class="">
        <div class="authTabDiv">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item"><a class="btnBorder th-font col737 bg-light me-3 disabled-tab" href="#" data-bs-toggle="tab">Invoice</a></li>
                <li class="nav-item"><a class="btnBorder th-font col737 bg-light me-3 disabled-tab" href="#" data-bs-toggle="tab">Payments</a></li>
                <li class="nav-item"><a class="btnBorder th-font col737 bg-light me-3 disabled-tab" href="#" data-bs-toggle="tab">ShipTo</a></li>
                <li class="nav-item"><a class="btnBorder th-font col737 bg-light me-3 disabled-tab" href="#" data-bs-toggle="tab">Pickups</a></li>
                <li class="nav-item"><a class="btnBorder th-font col737 bg-light me-3 disabled-tab" href="#" data-bs-toggle="tab">Pickup Address</a></li>
                <li class="nav-item"><a class="btnBorder th-font col737 bg-light disabled-tab" href="#" data-bs-toggle="tab">Deposite</a></li>                
            </ul>
        </div>
