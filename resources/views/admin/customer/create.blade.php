    ...
    <div class="">
        <div class="authTabDiv">
            <ul class="nav nav-tabs">
                <li class="nav-item"><a class="btnBorder th-font col737 bg-light me-3 active" href="#customerDetails" data-bs-toggle="tab">Customer Details</a></li>
                <li class="nav-item"><a class="btnBorder th-font col737 bg-light me-3" href="#Invoice" data-bs-toggle="tab">Invoice</a></li>
                <li class="nav-item"><a class="btnBorder th-font col737 bg-light me-3" href="#Payments" data-bs-toggle="tab">Payments</a></li>
                            ...
                            <div class="borderset">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <input type="text" name="first_name" class="form-control inp" placeholder="Enter Full Name" value="{{ old('first_name') }}">
                                        @error('first_name')
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="website_url" class="form-control inp" value="{{ old('website_url') }}" placeholder="Enter Website ID">
                        ...
                        <div class="borderset">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input type="text" name="email" class="form-control inp" placeholder="Enter Email ID" value="{{ old('email') }}">
                                    @error('email')
                                    <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" value="{{ $warehouses[0]->warehouse_name }}" readonly style="background-color: #e9ecef; color: #6c757d;">
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <div class="daterangepicker-wrap cal-icon cal-icon-info">
                                        <input type="text" name="signature_date" readonly style="cursor: pointer;" class="btn-filters  form-cs inp  inputbackground" value="{{ old('signature_date') }}" placeholder="mm-dd-yy" />
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2">
                                    <label class="foncolor " for="Year_to_Date">Year to Date</label>
                                    <input type="text" name="year_to_date" id="Year_to_Date" class="form-control inp inputbackground" placeholder="0" maxlength="4" pattern="\d*" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 4);" value="{{ old('year_to_date') }}" />
                                </div>
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <div class="daterangepicker-wrap cal-icon cal-icon-info">
                                        <input readonly style="cursor: pointer;" type="text" name="license_expiry_date" class="btn-filters  form-cs inp " value="{{ old('license_expiry_date') }}" placeholder="mm-dd-yy" />
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2">
                                            ...
                                            <td>
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <ul>
                                                            <li>
                                                                <a class="dropdown-item" href="#"><i class="ti ti-edit fs_18 me-2"></i>Update</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#individualPayment"><i class="ti ti-cash fs_18 me-2"></i>Payment</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item" href="#"><i class="ti ti-printer fs_18 me-2"></i>PDF</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#sendinvoicepdf"><i class="ti ti-mail fs_18 me-2"></i>Send</a>
                                                            </li>
                                                            <li>
                                        ...
                                        <td>
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul>
                                                        <li>
                                                            <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#InvoiceLabel"><i class="ti ti-printer fs_18 me-2"></i>PDF</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#sendinvoicepdf"><i class="ti ti-mail fs_18 me-2"></i>Send</a>
                                                        </li>
            ...
            <form class="invoice">
                <div class="row justify-content-between mb-3">
                    ...
                    <div class="col-md-6 text-end">
                        <a href="{{ route('admin.createShipTo') }}" class="btn btn-primary buttons">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-0">
                    <body style="font-family: 'Poppins', sans-serif; margin: 0; padding: 0; font-size: 12px; color: #000;">
                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse; max-width:400px; margin: 0 auto; background: #fff; border: 1px solid #ffffff;">
                            <tr>
                                <td>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="text-align: right;">
                                                    <img style="width: 70px; margin-right: 5px;" src="https://afrocargo.senomicsecurity.in/public/assets/images/AfroCargoLogo.svg">
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <table aria-describedby="table-description" style="width: 100%; table-layout: fixed; border-top: 1px solid #000000; border-bottom: 1px solid #000000;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding-top: 10px; padding-bottom: 10px; font-weight: 700; font-size: 13px;"> 04/11/2025</td>
                                                <td style="padding-top: 10px; padding-bottom: 10px; font-weight: 700; font-size: 13px; text-align: right;">
                                                    User: Dra Sacko </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table aria-describedby="table-description" style="width: 100%; table-layout: fixed; border-bottom: 1px solid #000;">
                                        ...
                                        <tbody>
                                            <tr></tr>
                                            <tr>
                                                <td colspan="3"><b style="font-size: 13px;">Customer:</b><br> Fatoumata <br> 2366 Grand Concourse New York
                                                    Bronx 10458
                                                    <br>
                                                ...
                                                <td>
                                                    <table style="width: 100%; border-collapse: collapse;" cellpadding="0" cellspacing="0">
                                                        <thead style="background-color: #E7E9F6;">
                                                            <th style="border: 1px solid #3a3a3a; border-collapse: collapse; padding: 5px; font-weight: 500;">
                                                                P.Type</th>
                                                            <th style="border: 1px solid #3a3a3a; border-collapse: collapse; padding: 5px; font-weight: 500;">
                                                                Dollar</th>
                                                            <th style="border: 1px solid #3a3a3a; border-collapse: collapse; padding: 5px; font-weight: 500;">
                                                        ...
                                                        <tbody>
                                                            <td style="border: 1px solid #3a3a3a; border-collapse: collapse; padding: 5px;">Cash</td>
                                                            <td style="border: 1px solid #3a3a3a; border-collapse: collapse; padding: 5px;">$ 30 </td>
                                                            <td style="border: 1px solid #3a3a3a; border-collapse: collapse; padding: 5px;">--</td>
                                                            <td style="border: 1px solid #3a3a3a; border-collapse: collapse; padding: 5px;">$ 30</td>
                                                            <td style="border: 1px solid #3a3a3a; border-collapse: collapse; padding: 5px;">$ 500.00</td>
                                                        </tbody>
                                                    </table>
                                                </td>
                                            </tr>
