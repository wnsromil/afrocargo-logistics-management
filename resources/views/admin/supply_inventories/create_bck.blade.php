        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="input-block mb-3">
                    ...
                    <select class="form-select fw-normal profileUpdateFont opacity-75 p-2" name="inventory_type" aria-label="Default select example">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="input-block mb-3">
                    ...
                    <select class="form-select fw-normal profileUpdateFont opacity-75 p-2" name="warehouse_id" aria-label="Default select example">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-3">
                            <div class="input-block mb-3 d-flex align-items-center">
                                ...
                                <input class="form-check-input mt-0" type="radio" value="Supply" name="inventoryType">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="row justify-content-end">
                        ...
                        <div class="col-md-2">
                            <div class="input-block mb-3 d-flex align-items-center">
                                <label class="foncolor mb-0 pt-0 me-2 col3A">Yes</label> <input class="form-check-input mt-0" type="radio" value="yes" name="barcode">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="input-block mb-3 d-flex align-items-center">
                                <label class="foncolor mb-0 pt-0 me-2 col3A">No</label> <input class="form-check-input mt-0" checked type="radio" value="No" name="barcode">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-12 mt-n6">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-block">
                                <label class="foncolor fw_500 m-0 p-0">Default Driver App <i class="text-danger">*</i></label>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="input-block mb-3 d-flex align-items-center">
