                    ...
                    @forelse ($parcels as $index => $parcel)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="pickup-tooltip" data-bs-toggle="tooltip"
                                                data-tooltip-html="{{ $pickupTooltip }}">
                                        ...
                                        <td>
                                            ...
                                            <div class="pickup-tooltip" data-bs-toggle="tooltip"
                                                data-tooltip-html="{{ $deliveryTooltip }}">
                                                        ...
                                                        <div class="subscription-menu">
                                                            <ul>
                                                                @php
                                                                    ...
                                                                    $isSelfPickup = $parcel->pickup_type === 'self';
                                                                @endphp
                                                                <li>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    {{
                                                                    $parcel->pickup_type === 'self'
                                                                    ? 'disabled-link'
                                                                    : ($currentStatusId == 2
                                                                        ? 'active disabled-link-for-active-service'
                                                                        : ($currentStatusId == 1 || $currentStatusId == 23
                                                                            ? ''
                                                                            : 'disabled-link'))
                                                                    }}" data-bs-toggle="modal" data-bs-target="#Pick_up_with_driver" data-id="{{ $parcel->id }}"
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item  {{ $currentStatusId == 4 ? 'active disabled-link-for-active-service' : ($currentStatusId == 3 && $isSelfPickup ? '' : 'disabled-link') }}"
