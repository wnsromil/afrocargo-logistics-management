<x-app-layout>
    ...
    <form action="{{ route('admin.inventories.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group-customer customer-additional-form InventoryFrom">
            <div class="row">
                <div class="col-md-7">
                    <div class="row">
                        ...
                        <div class="w-max-content">
                            <div class="input-block mb-3 d-flex align-items-center">
                                ...
                                <input class="form-check-input mt-0" type="radio" value="Ocean Cargo"
                                    name="inventary_sub_type"
                                    {{ old('inventary_sub_type', 'Ocean Cargo') === 'Ocean Cargo' ? 'checked' : '' }}>
                            </div>
                        </div>
                        ...
                        <div class="w-max-content">
                            <div class="input-block mb-3 d-flex align-items-center">
                                ...
                                <input class="form-check-input mt-0" type="radio" value="Air Cargo"
                                    name="inventary_sub_type"
                                    {{ old('inventary_sub_type') === 'Air Cargo' ? 'checked' : '' }}>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="input-block mb-3 d-flex align-items-center">
                                <label class="foncolor mb-0 pt-0 me-2 col3A">Yes</label> <input
                                    ...
                                    {{ old('barcode') === 'Yes' ? 'checked' : '' }} value="Yes" name="barcode">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="input-block mb-3 d-flex align-items-center">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12" id="retail_vaule_price" style="display: none;">
                    <div class="input-block mb-3">
                        <label for="retail_vaule_price"
                            class="table-content col737 fw-medium required text-dark">Retail
                            Price</label>
                        <div class="d-flex align-items-center justify-content-between form-control">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="input-block">
                        ...
                        <div class="input-block mb-3 service-upload img-size2 mb-0">
                            ...
                            <input type="file" id="inventory_image" name="img" class="form-control"
                                accept="image/*">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="input-block mb-3 d-flex align-items-center">
                                <label class="foncolor mb-0 pt-0 me-2 col3A">Yes</label> <input
                                    class="form-check-input mt-0" type="radio" value="Yes"
                                    name="driver_app_access"
                        ...
                        <div class="col-md-2">
                            <div class="input-block mb-3 d-flex align-items-center">
                                <label class="foncolor mb-0 pt-0 me-2 col3A">No</label> <input
                                    ...
                                    {{ old('driver_app_access', 'No') === 'No' ? 'checked' : '' }} type="radio"
                                    value="No" name="driver_app_access">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 pt-3 mt-3 border-top">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="input-block mb-3">
                            ...
                            <input class="form-control input-padding" name="item_length_inch" id="length"
                                type="number" step="any" value="{{ old('item_length_inch') }}"
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12" id="capacityDiv" style="display:none;">
                        <div class="input-block mb-3">
                            <label for="capacity" class="table-content col737 fw-medium">Capacity<i
                                    class="text-danger">*</i></label>
                            <input class="form-control input-padding" name="capacity" id="capacity_supply"
                                type="text" step="any" value="{{ old('capacity') }}"
                ...
                <div id="cargoDiv" style="display:none;">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                <label for="height" class="table-content col737 fw-medium">Volume
                                    Price(1*1*1)</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="input-block mb-3 d-flex align-items-center">
                                        <label class="foncolor mb-0 pt-0 me-2 col3A">Yes</label> <input
                                            class="form-check-input mt-0"
                                            {{ old('insurance_have') === 'Yes' ? 'checked' : '' }} type="radio"
                                ...
                                <div class="col-md-2">
                                    <div class="input-block mb-3 d-flex align-items-center">
                                        <label class="foncolor mb-0 pt-0 me-2 col3A">No</label> <input
                                            class="form-check-input mt-0"
                                            {{ old('insurance_have', 'No') === 'No' ? 'checked' : '' }} type="radio"
                ...
                <div id="supplyDiv" style="display:none;">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block border-0 mb-3">
                                ...
                                <select class="js-example-basic-single select2" id="color" name="color">
                                    <option value="" disabled {{ old('color') ? '' : 'selected' }}>Select Color
                                    </option>
                                    @php
                                        $colors = [
                                            'Amber',
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block border-0 mb-3">
                                ...
                                <select class="js-example-basic-single select2" id="open_supply" name="open">
                                    <option value="" disabled {{ old('open') ? '' : 'selected' }}>Select Open
                                    </option>
                                    <option value="Top" {{ old('open') == 'Top' ? 'selected' : '' }}>Top</option>
                                    <option value="Bottom" {{ old('open') == 'Bottom' ? 'selected' : '' }}>Bottom
                                    </option>
                                    <option value="Left" {{ old('open') == 'Left' ? 'selected' : '' }}>Left</option>
                                    <option value="Right" {{ old('open') == 'Right' ? 'selected' : '' }}>Right
                                    </option>
                                    <option value="Front" {{ old('open') == 'Front' ? 'selected' : '' }}>Front
                                    </option>
                                    <option value="Back" {{ old('open') == 'Back' ? 'selected' : '' }}>Back</option>
                                    <option value="Top & Bottom"
                                        {{ old('open') == 'Top & Bottom' ? 'selected' : '' }}>Top
                                        & Bottom</option>
                                    <option value="Left & Right"
                                        {{ old('open') == 'Left & Right' ? 'selected' : '' }}>
                                        Left & Right</option>
                                    <option value="All Sides" {{ old('open') == 'All Sides' ? 'selected' : '' }}>All
                                        Sides
                                    </option>
                                </select>
                                @error('open')
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                ...
                                <input class="form-control input-padding" readonly type="number" name="value_price"
                                    value="{{ old('value_price', default: 0) }}" placeholder="Value Price"
                                    step="any" aria-label="default input example" style="background: #ececec;">
                                @error('value_price')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                <label for="weight" class="table-content col737 fw-medium">Last Date
                                    Received</label>
