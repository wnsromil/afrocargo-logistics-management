<x-app-layout>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="input-block mb-3">
                    <label for="inventory_type" class="table-content col737 fw-medium">Inventory Type <i class="text-danger">*</i></label>
                    <select class="form-select fw-normal profileUpdateFont select2" name="inventory_type" aria-label="Default select example">
                        <option value="">Select / Add Inventory</option>
                        @foreach ($categories as $category)
                        <option {{ old('inventory_type')==$category->name ? 'selected' : '' }} value="{{ $category->name }}">{{ ucfirst($category->name) }}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="input-block mb-3">
                    ...
                    <select class="form-select fw-normal profileUpdateFont select2" name="warehouse_id" aria-label="Default select example">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center justify-content-between relative input-block mb-3">
                        <input class="form-control text-dark" type="number" name="price" value="{{ old('price') }}" placeholder="Enter price">
    ...
    {{-- <form action="{{ route('admin.inventories.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="input-block border-0 mb-3">
                        <label for="warehouse_id" class="table-content col737 fw-medium">Package Type <i class="text-danger">*</i></label>

                        <select class="form-control select2" name="packageType">
                            <option disabled hidden selected value="">Select Package Type</option>
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="input-block">
                        <label class="foncolor fw_500">Default Driver App <i class="text-danger">*</i></label>
                    </div>
                    <div class="row align-content-center">
                        <div class="col-md-2">
                            <div class="input-block d-flex align-items-center">
                                <label class="foncolor mb-0 pt-0 me-2 col3A">Yes</label> <input class="form-check-input mt-0" type="radio" value="yes" name="defaultDriver">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="input-block d-flex align-items-center">
                                <label class="foncolor mb-0 pt-0 me-2 col3A">No</label> <input class="form-check-input mt-0" checked type="radio" value="No" name="defaultDriver">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 pt-3 mt-3 border-top">
                <div id="cargoDiv">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block border-0 mb-3">
                                <label for="warehouse_id" class="table-content col737 fw-medium">State <i class="text-danger">*</i></label>

                                <select class="form-control select2" name="warehouse_id">
                                    <option disabled hidden selected value="">Select State</option>
                                    <option value="USA">LA</option>
                                    <option value="USA">San Andreas</option>
                                </select>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                ...
                                <input class="form-control input-padding" name="length" id="length" type="number" step="any" value="" placeholder="Enter Item Length" aria-label="default input example">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                ...
                                <input class="form-control input-padding" name="width" id="width" type="number" step="any" value="" placeholder="Enter Width" aria-label="default input example">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                ...
                                <input class="form-control input-padding" name="height" id="height" type="number" step="any" value="" placeholder="Enter Height" aria-label="default input example">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                ...
                                <input class="form-control input-padding" readonly name="volume" id="volume" type="number" step="any" value="" placeholder="value" aria-label="default input example">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                <label for="in_price" class="table-content col737 fw-medium required text-dark">Unit Price </label>
                                <div class="d-flex align-items-center justify-content-between form-control">
                                    <input class="no-border" type="number" name="unit_price" value="{{ old('price') }}" placeholder="Enter Unit price">
                                    <i class="fa-solid fa-dollar-sign" style="color: #595C5F;"></i>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                <label for="height" class="table-content col737 fw-medium">Factor<i class="text-danger">*</i></label>
                                <input class="form-control input-padding" name="Factor" type="number" value="5000" placeholder="value" aria-label="default input example">
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="input-block mb-3 d-flex align-items-center">
                                        <label class="foncolor mb-0 pt-0 me-2 col3A">Yes</label> <input class="form-check-input mt-0" type="radio" value="yes" name="haveInsurance">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="input-block mb-3 d-flex align-items-center">
                                        <label class="foncolor mb-0 pt-0 me-2 col3A">No</label> <input class="form-check-input mt-0" checked type="radio" value="No" name="haveInsurance">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                ...
                                <input class="form-control input-padding" readonly name="insuranceName" id="insuranceName" type="text" placeholder="Enter Insurance" aria-label="default input example">
                ...
                <div id="supplyDiv" style="display:none;">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                <label for="weight" class="table-content col737 fw-medium">Qty on hand<i class="text-danger">*</i></label>
                                <input class="form-control input-padding" readonly type="number" name="qtyOnHand" value="0" placeholder="Qty on hand" step="any" aria-label="default input example">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                ...
                                <input class="form-control input-padding" readonly type="number" name="retailValuePrice" value="0" placeholder="Retail Value Price" step="any" aria-label="default input example">
                            </div>
                        </div>

                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                <label for="weight" class="table-content col737 fw-medium">Value Price<i class="text-danger">*</i></label>
                                <input class="form-control input-padding" readonly type="number" name="valuePrice" value="0" placeholder="Value Price" step="any" aria-label="default input example">
                            </div>
                        </div>

                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                <label for="weight" class="table-content col737 fw-medium">Last Cost Received</label>
                                <input class="form-control input-padding" type="number" name="reorderPoint" placeholder="Enter Last Cost Received" readonly value="0" aria-label="default input example">
                            </div>
                        </div>

                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                <label for="weight" class="table-content col737 fw-medium">Re-order Point</label>
                                <input class="form-control input-padding" type="number" name="reorderPoint" placeholder="Enter Re-order Point" aria-label="default input example">
                            </div>
                        </div>

                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                <label for="weight" class="table-content col737 fw-medium">Re-order Quantity</label>
                                <input class="form-control input-padding" type="number" name="reorderQuantity" placeholder="Enter Re-order Quantity" aria-label="default input example">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                ...
                                <div class="daterangepicker-wrap cal-icon cal-icon-info">
                                    <input type="text" name="LastDateReceived" readonly class="btn-filters  form-cs inp  inputbackground" placeholder="MM-DD-YYYY" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                ...
                                <input class="form-control input-padding" type="number" name="reorderQuantity" placeholder="Enter Tax" aria-label="default input example">
                            </div>
                        </div>
        ...
        <div class="add-customer-btns d-flex justify-content-between">
    ...
    @section('script')
    <script>
        const insuranceRadios = document.querySelectorAll('input[name="haveInsurance"]');
