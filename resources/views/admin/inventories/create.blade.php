                        ...
                        <div class="d-flex">
                            <p class="profileUpdateFont" id="activeText">Active</p>
                                <div class="status-toggle px-2">
                                        <input id="toggleButton" class="check" type="checkbox">
                                        <label for="toggleButton" class="checktoggle log checkbox-bg">checkbox</label>
                                    </div>
                            <p class="profileUpdateFont" id="inactiveText">Inactive</p>
                        </div>
                    </div>
                </div>
