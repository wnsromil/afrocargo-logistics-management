                        ...
                        <tbody>
                            @forelse ($incoming_containers as $index => $incoming_container)
                                                        <tr>
                                                            ...
                                                            <td>{{ \Carbon\Carbon::parse($incoming_container->container->open_date)->format('m-d-Y') }}
                                                            </td>
                                                            <td>{{ \Carbon\Carbon::parse($incoming_container->container->close_date)->format('m-d-Y') }}
                                                            </td>
                                                                                                                        ...
                                                                                                                        <li>
                                                                                                                            @if($incoming_container->status == 18)
                                                                                                                                <a class="dropdown-item" href="javascript:void(0);"
                                                                                                                                    ...
                                                                                                                                    vehicle-id="{{ $incoming_container->container_id }}">Full discharge</a>
                                                                                                                            @else
                                                                                                                                <a class="dropdown-item text-muted disabled"
                                                                                                                                    href="javascript:void(0);">
                                                                                                                                    Full discharge
                                                            ...
                                                            <td class="btntext">
                                                                <button onClick="redirectTo('{{route('admin.container.orders.percel.list', [$incoming_container->id ?? 0, 'Arrived'])}}')"
                            ...
                            @foreach ($container_historys as $container_history)
                                                        <tr class="historyTR" style="background-color: #e9f7e9;"> {{-- Halka green background --}}
                                                            ...
                                                            <td class="btntext">
                                                                <button onClick="redirectTo('{{route('admin.container.orders.percel.list', [$container_history->id ?? 0, 'Arrived'])}}')"
                                                                    class=orderbutton><img src="{{ asset('assets/img/ordereye.png') }}"></button>
                                                            </td>
                                                        </tr>
                            @endforeach
