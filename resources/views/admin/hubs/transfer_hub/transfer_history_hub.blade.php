<x-app-layout>
    <x-slot name="header">
        {{ __('Container Transfer History') }}
    </x-slot>

    <x-slot name="cardTitle">
        <p class="head">Container Transfer History</p>
    </x-slot>
    ...
    <form id="expenseFilterForm" action="{{ route('admin.transfer.hub.history.list') }}" method="GET">
    ...
    <div id="ajexTable">
       @include('admin.hubs.transfer_hub.transfer_history_hub_table')
    </div>
    ...
    @section("script")
        ...
        <script>
            function resetForm() {
                window.location.href = "{{ route('admin.transfer.hub.history.list') }}";
            }
        </script>
    @endsection
