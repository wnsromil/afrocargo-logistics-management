<x-app-layout>
    <x-slot name="header">
        {{ __('Container Received History') }}
    </x-slot>

    <x-slot name="cardTitle">
        <p class="head">Container Received History</p>
    </x-slot>
    ...
    <form id="expenseFilterForm" action="{{ route('admin.received.hub.history.list') }}" method="GET">
    ...
    <div id="ajexTable">
       @include('admin.hubs.received_hub.received_history_hub_table')
    </div>
    ...
    <script>
        function resetForm() {
            window.location.href = "{{ route('admin.received.hub.history.list') }}";
        }
    </script>
