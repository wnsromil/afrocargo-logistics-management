            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="input-block mb-3">
                        ...
                        <div class="daterangepicker-wrap cal-icon cal-icon-info">
                            <input type="text" name="license_expiry_date" class="btn-filters  form-cs inp " style="cursor: pointer;" placeholder="Select Expiry Date" value="{{ old('license_expiry_date') }}">
                        </div>
                        @error('license_expiry_date')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="input-block mb-3">
                        ...
                        <input type="text" name="driverUsername" class="form-control inp" placeholder="Enter User Name" value="{{ old('driverUsername') }}">
                        @error('driverUsername')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="input-block mb-3 d-flex align-items-center">
                                    <label class="foncolor mb-0 pt-0 me-2 col3A" for="driverFor">P (Pickup)</label> <input class="form-check-input mt-0" checked type="radio" value="pickup" name="driverFor">
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="input-block mb-3 d-flex align-items-center">
                                    <label class="foncolor mb-0 pt-0 me-2 col3A" for="driverFor">D (Delivery)</label> <input class="form-check-input mt-0" type="radio" value="Delivery" name="driverFor">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="input-block mb-1">
                        <label class="foncolor" for="customerpickup">Customer Pickup Only (Mobile)<i class="text-danger">*</i></label>
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="input-block mb-3 d-flex align-items-center">
                                    <label class="foncolor mb-0 pt-0 me-2 col3A" for="customerpickup">Yes</label> <input class="form-check-input mt-0" type="radio" value="Yes" name="customerpickup">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="input-block mb-3 d-flex align-items-center">
                                    <label class="foncolor mb-0 pt-0 me-2 col3A" for="customerpickup">No</label> <input class="form-check-input mt-0" checked type="radio" value="No" name="customerpickup">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="input-block mb-3 d-flex align-items-center">
                                    <label class="foncolor mb-0 pt-0 me-2 col3A" for="customerpickup">All</label> <input class="form-check-input mt-0" type="radio" value="All" name="customerpickup">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="input-block mb-1">
                        <label class="foncolor" for="customerdelivery">Customer Delivery Only (Mobile)<i class="text-danger">*</i></label>
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="input-block mb-3 d-flex align-items-center">
                                    <label class="foncolor mb-0 pt-0 me-2 col3A" for="customerdelivery">Yes</label> <input class="form-check-input mt-0" type="radio" value="Yes" name="customerdelivery">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="input-block mb-3 d-flex align-items-center">
                                    <label class="foncolor mb-0 pt-0 me-2 col3A" for="customerdelivery">No</label> <input class="form-check-input mt-0" checked type="radio" value="No" name="customerdelivery">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="input-block mb-3 d-flex align-items-center">
                                    <label class="foncolor mb-0 pt-0 me-2 col3A" for="customerdelivery">All</label> <input class="form-check-input mt-0" type="radio" value="All" name="customerdelivery">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="input-block mb-1">
                        <label class="foncolor" for="addPickupsMobile">Add Pickups Mobile<i class="text-danger">*</i></label>
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="input-block mb-3 d-flex align-items-center">
                                    <label class="foncolor mb-0 pt-0 me-2 col3A" for="addPickupsMobile">Yes</label> <input class="form-check-input mt-0" type="radio" value="Yes" name="addPickupsMobile">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="input-block mb-3 d-flex align-items-center">
                                    <label class="foncolor mb-0 pt-0 me-2 col3A" for="addPickupsMobile">No</label> <input class="form-check-input mt-0" checked type="radio" value="No" name="addPickupsMobile">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="input-block mb-1">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="input-block mb-3 d-flex align-items-center">
                                    <label class="foncolor mb-0 pt-0 me-2 col3A" for="ChangePickupDate">Yes</label> <input class="form-check-input mt-0" type="radio" value="Yes" name="ChangePickupDate">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="input-block mb-3 d-flex align-items-center">
                                    <label class="foncolor mb-0 pt-0 me-2 col3A" for="ChangePickupDate">No</label> <input class="form-check-input mt-0" checked type="radio" value="No" name="ChangePickupDate">
                                </div>
                            </div>
                        </div>
                    </div>
