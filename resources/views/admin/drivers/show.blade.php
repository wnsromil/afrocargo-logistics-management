...
<x-app-layout>
    ...
    <div class="text-end mt-n4">
        <a class="btn update btn-primary me-2" href="{{ route('profile.edit') }}"><i class="ti ti-edit"></i> Update Driver</a>
    </div>
    <section>
                ...
                <div class="customer-details">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="customer-details-cont">
                            ...
                            <p class="col3A fw_500">{{ $user->phone ?? '+1 433 556 4443' }}</p>
                            <p class="col3A fw_500">{{ $user->phone_2 ?? '+1 525 564 7447'}}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="customer-details">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="customer-details-cont">
                            ...
                            <p class="col3A fw_500">{{ $user->address ?? '4712 Cherry Ridge Drive Rochester, NY 14620.' }}</p>
                            <p class="col3A fw_500">{{ $user->address_2 ?? 'B2 Luxe Hotel, San Tiago NY 14620.'}}</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="d-flex align-items-center">
                        <span class="customer-widget-img d-inline-flex">
                            <div class="profile-picture text-center mb-0">
                                <div class="upload-profile me-2">
                                    <div class="profile-img">
                                        <img id="blah" class="avatar" src="{{ asset('assets/images/license_ID.jpg') }}" alt="driving license">
                                    </div>
                                </div>
                            </div>
                        </span>
                        <div class="customer-details-cont">
                            <h6 class="fs_20 fw_600 col00 mb-1">License ID</h6>
                            <p class="col3A fw_500">Driving License</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-12 my-4">
                <div class="customer-details">
                    <div class="d-flex align-items-center">
                        <span class="customer-widget-img d-inline-flex">
                            <div class="iconwrapper me-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-id">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                            ...
                                            <div class="card activityCard">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <p class="col737 fs_18 fw_500">08:45 AM — <label class="col00 mb-0">Login</label></p>
                                            ...
                                            <div class="card activityCard">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <i class="ti ti-clock-filled"></i>
                                                        <div>
                                                            <p class="col737 fs_18 fw_500">10:15 AM — <label class="col00 mb-0">Customer Added</label></p>
                                                            <p class="col737 fs_18 fw_500">Customer Name: — <label class="col00 mb-0">Acme Corp</label></p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card activityCard">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <i class="ti ti-clock-filled"></i>
                                                        <div>
                                                            <p class="col737 fs_18 fw_500">10:15 AM — <label class="col00 mb-0">Order Pickup Scheduled</label></p>
                                                            <p class="col737 fs_18 fw_500">Tracking ID: — <label class="col00 mb-0">WE97078893</label></p>
                                                            <p class="col737 fs_18 fw_500">Pickup Date: — <label class="col00 mb-0">02-15-2025</label></p>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex mt-4">
                                                        <button class="btn btn-primary smbtn me-2">View</button>
                                            ...
                                            <div class="card activityCard">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <i class="ti ti-clock-filled"></i>
                                                        <div>
                                                            <p class="col737 fs_18 fw_500">02:00 PM — <label class="col00 mb-0">Payment Collected</label></p>
                                                            <p class="col737 fs_18 fw_500">Amount — <label class="col00 mb-0">$500</label></p>
                                                            <p class="col737 fs_18 fw_500">Mode — <label class="col00 mb-0">Cash</label></p>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex mt-4">
                                                        <button class="btn btn-primary smbtn me-2">View</button>
                                            ...
                                            <div class="card activityCard">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <i class="ti ti-clock-filled"></i>
                                                        <div>
                                                            <p class="col737 fs_18 fw_500">03:45 PM — <label class="col00 mb-0">Customer Deleted</label></p>
                                                            <p class="col737 fs_18 fw_500">Customer Name: — <label class="col00 mb-0">Acme Corp</label></p>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex mt-4">
                                            ...
                                            <div class="card activityCard">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <i class="ti ti-clock-filled"></i>
                                                        <div>
                                                            <p class="col737 fs_18 fw_500">04:30 PM — <label class="col00 mb-0">Invoice Deleted</label></p>
                                                            <p class="col737 fs_18 fw_500">Invoice ID: — <label class="col00 mb-0"> INV-12345</label></p>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex mt-4">
                                                        <button class="btn btn-primary smbtn me-2">View</button>
